...
class MasterdataConfig(BaseModel):
    ...
    matnr: Optional[str] = Field(None, alias="MATNR", description="Material number")
    ...
    xplant_status: Optional[str] = Field(None, alias="xplantStatus", description="Cross-plant status")
    prdhatxt: Optional[str] = Field(None, alias="prdhatxt", description="Product hierarchy text")
    ...
    contract_manufacturer_codetype: Optional[str] = Field(None, alias="contractManufacturerCodetype", description="Contract manufacturer codetype")
    contract_manufacturer_code: Optional[str] = Field(None, alias="contractManufacturerCode", description="Contract manufacturer code")
    ...
    visible_markings: Optional[str] = Field(None, alias="visibleMarkings", description="Visible markings")
    code: Optional[str] = Field(None, alias="code", description="Code")
    colors: Optional[str] = Field(None, alias="colors", description="Colors")
    number_colors_front: Optional[str] = Field(None, alias="numberColorsFront", description="Number of colors front")
    contract_manufacturer: Optional[str] = Field(None, alias="contractManufacturer", description="Contract manufacturer")
    article_codetype: Optional[str] = Field(None, alias="articleCodetype", description="Article codetype")
    article_code: Optional[str] = Field(None, alias="articleCode", description="Article code")
    contract_man_visible_markings: Optional[str] = Field(None, alias="contractManVisibleMarkings", description="Contract man visible markings")
    contract_manufacturer_mt_index: Optional[str] = Field(None, alias="contractManufacturerMtIndex", description="Contract manufacturer MT index")
    component_scrab_key: Optional[str] = Field(None, alias="componentScrabKey", description="Component scrab key")
    remarks: Optional[str] = Field(None, alias="remarks", description="Remarks")
    printed: Optional[str] = Field(None, alias="printed", description="Printed")
    number_colors_back: Optional[str] = Field(None, alias="numberColorsBack", description="Number of colors back")
    print_characteristics: Optional[str] = Field(None, alias="printCharacteristics", description="Print characteristics")
    braille_text: Optional[str] = Field(None, alias="brailleText", description="Braille text")
    ...
    dra_8: Optional[str] = Field(None, alias="dra8", description="DRA 8")
    dra_9: Optional[str] = Field(None, alias="dra9", description="DRA 9")
    dra_10: Optional[str] = Field(None, alias="dra10", description="DRA 10")
    lra: Optional[str] = Field(None, alias="lra", description="LRA")
    lra_version: Optional[str] = Field(None, alias="lraVersion", description="LRA version")
    ...
    hrl_version: Optional[str] = Field(None, alias="hrlVersion", description="HRL version")
    hrl_date: Optional[str] = Field(None, alias="hrlDate", description="HRL date")
    acs: Optional[str] = Field(None, alias="acs", description="ACS")
    acs_version: Optional[str] = Field(None, alias="acsVersion", description="ACS version")
    tpm_drawing: Optional[str] = Field(None, alias="tpmDrawing", description="TPM drawing")
    tpm: Optional[str] = Field(None, alias="tpm", description="TPM")
    tpmtxt: Optional[str] = Field(None, alias="tpmtxt", description="TPM text")
    tpm_status: Optional[str] = Field(None, alias="tpmStatus", description="TPM status")
    ...
    eclass: Optional[str] = Field(None, alias="eclass", description="ECLASS")
    eclasstxt: Optional[str] = Field(None, alias="eclasstxt", description="ECLASS text")
    eclass_s: Optional[str] = Field(None, alias="eclassS", description="ECLASS S")
